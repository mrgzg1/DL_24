...
class JEPA(nn.Module):
    def __init__(self, device="cpu", bs=64, n_steps=17, action_dim=2, config=None):
        ...
        self.encoder = Encoder(n_kernels=config.num_kernels, repr_dim=config.repr_dim, config=config)
